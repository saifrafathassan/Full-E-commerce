            ...
            .map((item, index) => {
                ...
                >
                    ...
                    <div className="flex justify-center cursor-pointer">
                        <img
                        className="rounded-2xl w-[400px] sm:w-full h-80 p-2 hover:scale-110 transition-scale-110 duration-300 ease-in-out"
                        src={imageUrl}
                        alt="blog"
                        />
                    </div>
