                    ...
                    <Tabs defaultIndex={0} className=" " >
                                ...
                                <div className="relative overflow-x-auto ">
                                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400  ">
                                        ...
                                        {sortedProducts.map((item, index) => {
                                            ...
                                            const {title, price, imageUrl, order, category, description, date} = item;
                        ...
                        <TabPanel>
                            ...
                            <div className="relative overflow-x-auto mb-16">
                                <h1 className=' text-center mb-5 text-3xl font-semibold ' style={{ color: mode === 'dark' ? 'white' : '' }}>Order Details</h1>
                                    ...
                                    return (
                                        <table key={index} className="w-full text-sm text-left text-gray-500 dark:text-gray-400" >
                                            ...
                                            {allorder.cartItems.map((item, index) => {
                                                const {title, imageUrl, category, price} = item;
                                                // console.log(item)
                                                return (
                                                    <tbody key={index}>
                                                    ...
                                                    <tr className="bg-gray-50 border-b  dark:border-gray-700" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                                                        <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
                                                            {allorder.paymobPaymentId ? allorder.paymobPaymentId.slice(-4) : 'N/A'}
                                                        </td>
                                                        <th scope="row" className="px-6 py-4 font-medium text-black whitespace-nowrap">
                                                            <img className='w-16' src={imageUrl} alt="img" />
                                                        </th>
                        ...
                        <TabPanel>
                            ...
                            <div className="relative overflow-x-auto mb-10">
                                <h1 className=' text-center mb-5 text-3xl font-semibold ' style={{ color: mode === 'dark' ? 'white' : '' }}>User Details</h1>
                                <table className="w-full text-sm text-gray-500 dark:text-gray-400">
                                    ...
                                    {user.map((item, index) => {
                                        ...
                                        return (
                                            <tbody key={index}>
                                            <tr className="bg-gray-50 border-b text-center dark:border-gray-700" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                                                <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
                                                    {index + 1}
                                                </td>
                                                <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
